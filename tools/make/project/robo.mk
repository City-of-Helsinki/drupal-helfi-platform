...
install-drupal-ci:
	...
	$(call docker_run_ci,app,set -e && drush en helfi_platform_config && for d in /app/public/modules/contrib/helfi_platform_config/helfi_features/*; do drush en -y $$(echo "$$d" | awk -F/ '{print $$NF}'); done)
